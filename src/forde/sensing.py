...
def hoyer_sparsity(x, axis=-1):
    ...
    Args:
        ...
        axis: The axis along which to calculate sparsity (default is the last dimension).
...
def calculate_neuron_stats(activations, gradients):
    ...
    # ⚡ Bolt Optimization: Use explicit axis instead of vmap + transpose to avoid overhead and memory layout changes (~3.7x faster)
