...
def calculate_neuron_stats(activations, gradients):
    ...
    act_gini = hoyer_sparsity(activations, axis=0)  # Apply explicitly along batch axis
    ...
    grad_gini = hoyer_sparsity(gradients, axis=0)  # Apply explicitly along batch axis
