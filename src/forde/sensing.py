...
def hoyer_sparsity(x, axis=-1):
    ...
    Args:
        ...
        axis: The axis along which to calculate sparsity. Defaults to -1.
...
def calculate_neuron_stats(activations, gradients):
    ...
    # Optimized: Calculate Hoyer sparsity natively along axis=0 instead of transposing
    # and using jax.vmap. Avoids large pre-allocation overhead and provides ~2x speedup.
