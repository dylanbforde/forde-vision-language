...
def hoyer_sparsity(x, axis=-1):
    ...
    Args:
        ...
        axis: The axis along which sparsity is calculated. Defaults to -1.
...
def calculate_neuron_stats(activations, gradients):
    ...
    act_gini = hoyer_sparsity(activations, axis=0)  # Compute directly along batch dim
    ...
    grad_gini = hoyer_sparsity(gradients, axis=0)  # Compute directly along batch dim
