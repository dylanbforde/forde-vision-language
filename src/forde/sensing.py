...
def hoyer_sparsity(x, axis=-1):
    ...
    Args:
        ...
        axis: The dimension along which to calculate sparsity (defaults to -1).
...
def calculate_neuron_stats(activations, gradients):
    ...
    act_gini = hoyer_sparsity(activations, axis=0) # Calculate Hoyer's along batch dimension
    ...
    grad_gini = hoyer_sparsity(gradients, axis=0) # Calculate Hoyer's along batch dimension
