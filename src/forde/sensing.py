...
def calculate_neuron_stats(activations, gradients):
    ...
    act_gini = hoyer_sparsity(activations, axis=0) # Apply Hoyer's per neuron across the batch
    ...
    grad_gini = hoyer_sparsity(gradients, axis=0) # Apply Hoyer's per neuron across the batch
