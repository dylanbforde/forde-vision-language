...
def hoyer_sparsity(x, axis=-1):
    ...
    Args:
        ...
        axis: Axis along which to calculate sparsity. Defaults to -1.
...
def calculate_neuron_stats(activations, gradients):
    ...
    act_gini = hoyer_sparsity(activations, axis=0) # Calculate directly across the batch dimension
    ...
    grad_gini = hoyer_sparsity(gradients, axis=0) # Calculate directly across the batch dimension
