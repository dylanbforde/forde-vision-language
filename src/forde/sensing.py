...
def hoyer_sparsity(x, axis=-1):
    ...
    Args:
        ...
        axis: The axis along which to calculate the sparsity. Defaults to -1.
...
def calculate_neuron_stats(activations, gradients):
    ...
    # Using explicit axis=0 avoids vmap + transpose memory overhead and speeds up the calculation
