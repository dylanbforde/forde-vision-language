...
def hoyer_sparsity(x, axis=-1):
    ...
    Args:
        ...
        axis: The axis along which to compute the sparsity.
...
def calculate_neuron_stats(activations, gradients):
    ...
    # Using explicit axis=0 instead of jax.vmap(hoyer_sparsity)(activations.T)
    # to avoid massive intermediate memory allocation and compilation bloat
