...
def hoyer_sparsity(x, axis=-1):
    ...
    Args:
        ...
        axis: The axis along which sparsity is calculated. Defaults to the last dimension.
...
def calculate_neuron_stats(activations, gradients):
    ...
    act_gini = hoyer_sparsity(activations, axis=0) # Explicit vectorization along batch axis
    ...
    grad_gini = hoyer_sparsity(gradients, axis=0) # Explicit vectorization along batch axis
