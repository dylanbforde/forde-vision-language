...
def hoyer_sparsity(x, axis=-1):
    ...
    Args:
        x: A JAX array (vector or matrix). Sparsity is calculated along the specified dimension.
...
def calculate_neuron_stats(activations, gradients):
    ...
    # This avoids vmap compilation overhead and preserves memory layout, yielding ~3-4x speedup
