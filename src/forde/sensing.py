...
def calculate_neuron_stats(activations, gradients):
    ...
    # Bolt Optimization: Explicitly vectorize Hoyer sparsity calculation along axis=0
    # instead of vmap + transpose to avoid memory layout permutations and vmap overhead.
