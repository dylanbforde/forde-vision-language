...
def calculate_neuron_stats(activations, gradients):
    ...
    # Bolt Optimization: Vectorize explicitly along axis=0 instead of vmap + transpose.
    # This prevents loop unrolling / huge intermediate allocation overhead during JIT.
