...
class MoELayer(nn.Module):
    ...
    def _compute_expert_outputs(
        ...
        # Optimized: Iterate over experts individually and accumulate using boolean masking
        # This avoids eagerly calculating and stacking all expert outputs (jnp.stack),
        # which drastically reduces memory allocations and compilation time.
        for i, expert in enumerate(experts):
            # Calculate weight of this expert for each token
