...
class ManifoldHyperConnection(nn.Module):
    ...
    def __call__(
        ...
        output_addition = output_addition.at[:, :, output_stream_idx, :].set(sublayer_output)
...
if __name__ == '__main__':
    ...
    print(f"   Mixing matrix doubly stochastic: {verify_doubly_stochastic(mixing_matrix)}")
